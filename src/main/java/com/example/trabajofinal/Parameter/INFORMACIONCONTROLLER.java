...
public class INFORMACIONCONTROLLER {
        ...
        private static Logger log = LogManager.getLogger(INFORMACIONCONTROLLER.class);
            ...
            if(info != null){
                ...
                for (int i = 0; i< 3;i++){
                    if(i<info.getNumeroElementos()) {
                        ...
                        muerte.getElemento(i).getData().setText("Muerte: " + info.getElemento(i).getData().getHistorial().getTurno());
                        clona.getElemento(i).getData().setText("Clonacion: " + info.getElemento(i).getData().getDatos().getPorcentajeclonacion());
                        id.getElemento(i).getData().setText("Id: " + info.getElemento(i).getData().getDatos().getID());
                        repro.getElemento(i).getData().setText("Reproducion: " + info.getElemento(i).getData().getDatos().getPorcentajereproduccion());
                        vida.getElemento(i).getData().setText("Clona: " + info.getElemento(i).getData().getDatos().getVida());
