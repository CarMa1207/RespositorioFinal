...
public class BucleDeControl {
    ...
    public ListaEnlazed<Celdas> ejecucion(ListaEnlazed<Celdas> celdas, ParameterDataModel individuosdatos, ParameterDataModelRecursos recursosdatos, TableroController tablero) {
        ...
        for (int j = 0; j < celdas.getNumeroElementos(); j++) {
            ...
            if (celdas.getElemento(j).getData().getRecursoListaEnlazed().getNumeroElementos() > 0 && celdas.getElemento(j).getData().getIndividuoListaEnlazed().getNumeroElementos() > 0) {
            ...
            if (celdas.getElemento(j).getData().getIndividuoListaEnlazed().getNumeroElementos() != 0) {
                for (int x = 0; x < celdas.getElemento(j).getData().getIndividuoListaEnlazed().getNumeroElementos(); x++) {
                    ...
                    if (!movido) {
                        ...
                        if (celdas.getElemento(j).getData().getIndividuoListaEnlazed().getElemento(x).getData().getRuta() == null || celdas.getElemento(j).getData().getIndividuoListaEnlazed().getElemento(x).getData().getRuta().getNumeroElementos() == 0) {
                            ...
                            if (recursos.getNumeroElementos() != 0) {
                                ...
                                if (individuo.getRuta() != null) {
                                    if (individuo.getRuta().getNumeroElementos() != 0) {
                        ...
                        funcionesBucle.getDescolodado(celdas.getElemento(j).getData().getIndividuoListaEnlazed().getElemento(x).getData().getCelda(), tableroDataModel.getFilas(), tableroDataModel.getColumnas());
                        celdas.getElemento(j).getData().getIndividuoListaEnlazed().del(x);
                        for (int u = 0; u < celdas.getNumeroElementos(); u++) {
                            if (celdas.getElemento(u).getData().getX() == individuo.getCelda().getX() && celdas.getElemento(u).getData().getY() == individuo.getCelda().getY()) {
                                celdas.getElemento(u).getData().getIndividuoListaEnlazed().add(individuo);
                            }
                        }
                    }
